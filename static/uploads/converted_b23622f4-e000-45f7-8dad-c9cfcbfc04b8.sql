...
Please note that MySQL does not support the `CREATE TYPE` syntax for creating custom ENUM types directly. You may need to handle the status values as strings in MySQL or use a different approach to achieve the same functionality.